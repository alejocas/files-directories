...
#### Con un directorio como argumento
![ls con un directorio como argumento](./Pruebas/Ex2-TmpDirectory.png)

#### Con -l y un directorio como argumentos
![ls con -l y un directorio como argumentos](./Pruebas/Ex2-TmpDirectory-L.png)

#### Con -l como argumento
![ls con -l como argumento](./Pruebas/Ex2-CurrentDirectory-L.png)

#### Sin argumentos
![ls sin argumentos](./Pruebas/Ex2-CurrentDirectory.png)
...
![Tail personalizado](./Pruebas/Ex3Tail.png)
